...
| POD | Node | Loopback0 |
| --- | ---- | --------- |
| DC1 | dc1-leaf1a | 10.255.1.1/32 |
| DC1 | dc1-leaf1b | 10.255.1.2/32 |
| DC1 | dc1-leaf2a | 10.255.1.3/32 |
| DC1 | dc1-leaf2b | 10.255.1.4/32 |
| DC1 | dc1-spine1 | 10.255.0.1/32 |
| DC1 | dc1-spine2 | 10.255.0.2/32 |

### VTEP Loopback VXLAN Tunnel Source Interfaces (VTEPs Only)

| VTEP Loopback Pool | Available Addresses | Assigned addresses | Assigned Address % |
| ------------------ | ------------------- | ------------------ | ------------------ |
| 10.255.2.0/24 | 256 | 4 | 1.57 % |

### VTEP Loopback Node allocation

| POD | Node | Loopback1 |
| --- | ---- | --------- |
| DC1 | dc1-leaf1a | 10.255.2.1/32 |
| DC1 | dc1-leaf1b | 10.255.2.1/32 |
| DC1 | dc1-leaf2a | 10.255.2.3/32 |
| DC1 | dc1-leaf2b | 10.255.2.3/32 |
