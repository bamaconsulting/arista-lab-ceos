...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.100.100.103/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF2 | Vlan4094 | 10.255.254.5 | Port-Channel3 |
...
| Ethernet5 | SERVER_server2_eth1 | *trunk | *11-12,21-22 | *4092 | *- | 5 |
...
| Port-Channel5 | SERVER_dc1-leaf2-server2_Bond1 | trunk | 11-12,21-22 | 4092 | - | - | - | 5 | - |
...
interface Port-Channel5
   description SERVER_dc1-leaf2-server2_Bond1
   no shutdown
...
| Vlan3009 |  VRF10  |  10.255.253.4/31  |  -  |  -  |  -  |  -  |
| Vlan3010 |  VRF11  |  10.255.253.4/31  |  -  |  -  |  -  |  -  |
...
| 10.255.253.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 10.255.253.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.253.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65102
   ...
   neighbor 10.255.253.5 description dc1-leaf2b_Vlan4093
   ...
   vrf VRF10
      ...
      router-id 10.255.1.3
      neighbor 10.255.253.5 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.253.5 description dc1-leaf2b_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 10.255.1.3
      neighbor 10.255.253.5 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.253.5 description dc1-leaf2b_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
