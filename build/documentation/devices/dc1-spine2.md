...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.100.100.11/24 | - |
...
| 10.255.1.2 | 65101 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - | - |
| 10.255.1.3 | 65102 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - | - |
...
router bgp 65000
   ...
   neighbor 10.255.1.1 description dc1-leaf1a_Loopback0
   neighbor 10.255.1.2 peer group EVPN-OVERLAY-PEERS
   neighbor 10.255.1.2 remote-as 65101
   neighbor 10.255.1.2 description dc1-leaf1b_Loopback0
   neighbor 10.255.1.3 peer group EVPN-OVERLAY-PEERS
   neighbor 10.255.1.3 remote-as 65102
   neighbor 10.255.1.3 description dc1-leaf2a_Loopback0
   neighbor 10.255.1.4 peer group EVPN-OVERLAY-PEERS
   neighbor 10.255.1.4 remote-as 65102
   neighbor 10.255.1.4 description dc1-leaf2b_Loopback0
