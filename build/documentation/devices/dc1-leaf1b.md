...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.100.100.102/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF1 | Vlan4094 | 10.255.254.0 | Port-Channel3 |
...
| Ethernet5 | SERVER_server1_eth1 | *trunk | *11-12,21-22 | *4092 | *- | 5 |
...
| Vlan3009 |  VRF10  |  10.255.253.1/31  |  -  |  -  |  -  |  -  |
| Vlan3010 |  VRF11  |  10.255.253.1/31  |  -  |  -  |  -  |  -  |
...
| 10.255.253.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 10.255.253.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.253.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65101
   ...
   neighbor 10.255.253.0 description dc1-leaf1a_Vlan4093
   ...
   vrf VRF10
      ...
      router-id 10.255.1.2
      neighbor 10.255.253.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.253.0 description dc1-leaf1a_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 10.255.1.2
      neighbor 10.255.253.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.253.0 description dc1-leaf1a_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
