...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 172.100.100.101/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF1 | Vlan4094 | 10.255.254.1 | Port-Channel3 |
...
| Vlan3009 |  VRF10  |  10.255.253.0/31  |  -  |  -  |  -  |  -  |
| Vlan3010 |  VRF11  |  10.255.253.0/31  |  -  |  -  |  -  |  -  |
...
| 10.255.253.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 10.255.253.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.253.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65101
   ...
   neighbor 10.255.253.1 description dc1-leaf1b_Vlan4093
   ...
   vrf VRF10
      ...
      router-id 10.255.1.1
      neighbor 10.255.253.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.253.1 description dc1-leaf1b_Vlan3009
   ...
   vrf VRF11
      ...
      router-id 10.255.1.1
      neighbor 10.255.253.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.253.1 description dc1-leaf1b_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
