...
def parse_args() -> argparse.Namespace:
	parser = argparse.ArgumentParser(description="Run 'show ip bgp summary' on all FABRIC devices via eAPI")
...
def main() -> int:
	...
	for inventory_host, ip in hosts:
		...
		try:
			...
			response = node.enable(["show ip bgp summary"], encoding="text")[0]
